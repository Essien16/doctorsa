...
export class VisitController {
  ...
  create = async (
    ...
    try {
      ...
      const validation = createVisitRequestSchema.safeParse(request.body);
  ...
  submitBid = async (
    ...
    try {
      ...
      const paramsValidation = visitIdParamsSchema.safeParse(request.params);
      ...
      const bodyValidation = submitBidRequestSchema.safeParse(request.body);
  ...
  getPatientVisit = async (
    ...
    try {
      ...
      const validation = visitIdParamsSchema.safeParse(request.params);
  ...
  listAssignedVisits = async (
    ...
    try {
      ...
      const visits = await this.listAssignedVisitsService.execute(
        request.session.userId,
      );
